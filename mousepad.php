...
if(isset($_POST["add"])){
   ...
   if(isset($_SESSION["cart"])){
       ...
       if(in_array($_POST["product_id"],$items_id)){
           ...
           $id = $_POST["product_id"];
           header("Location: already-added.php?id=".$id);
...
?>
 ...
 <div class="text-center">
    <div class="container">
        <div class="row"> 
    <?php
        $result = mysqli_query($con, "SELECT * FROM toxicbase.items where Tipus = 'mousepad'");
         ...
         <div class="card m-auto" style="width: 18rem;">
          <div class="card-body">
            <img class="card-img-top img-fluid" src="<?php echo $row['img'];?>">
              ...
              <input type="hidden" value="<?php echo $row['itemnumber']; ?>" name="product_id">
              <?php 
